...
[![Instagram](https://img.shields.io/badge/Instagram-%23E4405F.svg?style=for-the-badge&logo=Instagram&logoColor=white)](https://instagram.com/gzileni)
[![GitHub followers](https://img.shields.io/github/followers/gzileni?label=Follow&style=for-the-badge&logo=github&color=181717)](https://github.com/gzileni)
...
class GiuseppeZileni:
    def __init__(self):
        self.role       = "AI Senior Developer @ Hevolus Innovation"
        self.focus      = ["Agentic AI", "Multi-Agent Orchestration", "RAG", "Tool-Use / MCP"]
        self.languages  = ["Python", "TypeScript", "C#", "JavaScript", "Java"]
        self.ai_stack   = ["LangGraph", "LangChain", "Anthropic Claude",
                           "Azure AI Foundry", "OpenAI", "Model Context Protocol"]
        self.cloud      = ["Microsoft Azure", "AWS", "Google Cloud"]
...
![RAG](https://img.shields.io/badge/RAG_Pipelines-6E56CF?style=for-the-badge&logo=databricks&logoColor=white)
![Vector DB](https://img.shields.io/badge/Vector_DB-FF6F61?style=for-the-badge&logo=qdrant&logoColor=white)
